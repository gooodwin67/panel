...
let __tla = (async () => {
  ...
  class Je {
    constructor(e, t, i) {
      this.gameContext = e, this.config = t, this.onWallChanged = i, this.floor = null, this.ceiling = null, this.isNetVisible = true, this.activeWallIndex = null, this.gridSelectionColor = "#1612d3", this.inactiveGridOpacity = 0.45, this.activeGridOpacity = 1, this.textureLoader = new we(), this.baseGridTexture = this.createGridTexture(), this.wallTexture = this.textureLoader.load("textures/1/wall-color.jpg"), this.wallTexture.wrapS = C, this.wallTexture.wrapT = C, this.wallTexture.colorSpace = T, this.wallTexture.anisotropy = this.gameContext.renderer.capabilities.getMaxAnisotropy(), this.wallRoughness = this.textureLoader.load("textures/1/wall-roughness.jpg"), this.wallRoughness.wrapS = C, this.wallRoughness.wrapT = C, this.floorTexture = this.textureLoader.load("textures/1/floor-color.jpg"), this.floorNormal = this.textureLoader.load("textures/1/floor-normal.jpg"), this.floorRoughness = this.textureLoader.load("textures/1/floor-roughness.jpg"), [
        this.floorTexture,
        this.floorNormal,
        this.floorRoughness
      ].forEach((s) => {
        s.wrapS = C, s.wrapT = C;
      }), this.floorTexture.colorSpace = T, this.floorTexture.anisotropy = this.gameContext.renderer.capabilities.getMaxAnisotropy(), this.ceilingTexture = this.textureLoader.load("textures/1/ceiling-color.jpg"), this.ceilingTexture.wrapS = C, this.ceilingTexture.wrapT = C, this.ceilingTexture.colorSpace = T, this.ceilingTexture.anisotropy = this.gameContext.renderer.capabilities.getMaxAnisotropy(), this.createWalls();
    }
    createScene() {
    ...
    createWallPlane(e, t) {
      ...
      n.repeat.set(e / 2, t / 2), n.wrapS = C, n.wrapT = C, n.needsUpdate = true;
      const l = this.wallRoughness.clone();
      l.repeat.set(s, a);
      const o = this.baseGridTexture.clone();
      o.repeat.set(s, a), o.wrapS = C, o.wrapT = C, o.needsUpdate = true;
      const r = new W({
        map: n,
        roughnessMap: l,
        color: 16777215,
    ...
    async loadPanels() {
      const e = new j(0.49, 0.49), t = this.panelUrls.map((i, s) => this.loader.loadAsync(i).then((a) => {
        ...
        return n.scale.multiplyScalar(d), l.forEach((p) => {
          ...
          const I = Array.isArray(p.material) ? p.material[0].clone() : p.material.clone(), M = new L(e, I);
  ...
  function ce(u) {
    var _a, _b;
    (_b = (_a = P()) == null ? void 0 : _a.setAllPanelsColor) == null ? void 0 : _b.call(_a, u), Me(u), wt(u), ve("panel-global-color-preview", u);
  }
  function Me(u) {
  ...
  function It() {
    ...
    }, I = (m) => m && typeof m == "object" && m.mode && Object.prototype.hasOwnProperty.call(m, "state") ? m.mode : "3d", M = (m) => {
      try {
        return I(y(m));
      } catch (b) {
