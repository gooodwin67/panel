import { S as Ce, P as Le, W as Pe, a as T, b as Be, A as Ee, O as De, c as We, R as $, V, d as f, e as Z, f as Te, H as Fe, g as Ae, h as ze, G as R, M as W, i as re, j as L, C as ue, k as ye, D as Q, l as oe, m as ke, F, n as j, o as ge, p as x, Q as he, B as q, q as Ne, E as Re, L as Oe, r as He, T as we, s as I, t as Ue, u as Xe, v as Se, w as Ye, x as qe, y as Ve, z as je } from "./three-DbH9v004.js";
let Dt;
let __tla = (async () => {
  Dt = function() {
  ...
  class _e {
    constructor(e) {
      ...
      this.onWindowResize = this.onWindowResize.bind(this), this.scene = new Ce(), this.camera = new Le(40, window.innerWidth / window.innerHeight, 0.1 * t, 40 * t), this.camera.position.x = 0, this.camera.position.y = 0, this.camera.position.z = 10 * t, this.renderer = new Pe({
        antialias: true
      }), this.renderer.setPixelRatio(Math.min(window.devicePixelRatio, 2)), this.renderer.setSize(window.innerWidth, window.innerHeight), this.renderer.outputColorSpace = T, this.renderer.shadowMap.enabled = true, this.renderer.shadowMap.type = Be, this.renderer.toneMapping = Ee, this.renderer.toneMappingExposure = 0.58, this.renderer.physicallyCorrectLights = true, document.body.appendChild(this.renderer.domElement), this.controls = new De(this.camera, this.renderer.domElement), this.controls.rotateSpeed = 0.5, this.gameContext.controls = this.controls, this.stats = new We(), document.body.appendChild(this.stats.dom), this.stats.dom.style.display = "none", window.addEventListener("resize", this.onWindowResize), this.onWindowResize();
    }
    onWindowResize() {
  ...
  class et {
    ...
    createScene() {
      ...
      n.wrapS = I, n.wrapT = I, n.repeat.set(t, i), l.wrapS = I, l.wrapT = I, l.repeat.set(t, i), n.anisotropy = this.gameContext.renderer.capabilities.getMaxAnisotropy(), n.colorSpace = T, n.generateMipmaps = true, n.minFilter = Se;
      const o = new W({
        map: n,
        bumpMap: l,
        bumpScale: 0.08,
  ...
  class it {
    ...
    updateFurnitureTransform(e, t, i, s) {
      ...
      if (c) {
        ...
        const S = a.userData.baseHeight || 1, C = Math.max(t, Math.max(S * 0.15, 0.05));
        a.scale.set(o / n, C / S, 1);
  ...
  async function ut() {
    var _a, _b;
    await h.assetManager.loadModels(), xt(), Mt(), vt(), It(), Ct(), h.sceneClass.createScene(), h.sceneClass.onPanelsChanged = H, H(), h.guiClass && (h.guiClass.refresh(), h.guiClass.refreshLight(), (_b = (_a = h.guiClass).refreshAmbient) == null ? void 0 : _b.call(_a));
  }
  function gt() {
    wt(), bt(), ft(), Lt(), pt();
  }
  ...
  function ce(u) {
    var _a, _b;
    (_b = (_a = P()) == null ? void 0 : _a.setAllPanelsColor) == null ? void 0 : _b.call(_a, u), Me(u), St(u), ve("panel-global-color-preview", u);
  }
  function Me(u) {
